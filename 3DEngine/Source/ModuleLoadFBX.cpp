...
void ModuleLoadFBX::LoadFile(const char* file)
{
	...
	if (scene != nullptr && scene->HasMeshes())
	{
		...
		float4x4 transform = float4x4(rot.a1, rot.b1, rot.c1, rot.d1, rot.a2, rot.b2, rot.c2, rot.d2, rot.a3, rot.b3, rot.c3, rot.d3, rot.a4, rot.b4, rot.c4, rot.d4);

		// Create Transform Component from Current Scene Root Node
		object_parent->SetTransform(transform);
		...
		for (uint count = 0; count < n_meshes; count++)
		{
			...
			float4x4 r_transform = float4x4(crot.a1, crot.b1, crot.c1, crot.d1, crot.a2, crot.b2, crot.c2, crot.d2, crot.a3, crot.b3, crot.c3, crot.d3, crot.a4, crot.b4, crot.c4, crot.d4);

			object_child->SetTransform(r_transform);
